    ...
    implements Parcelable, ParcelWrapper<com.codepath.apps.restclienttemplate.models.Entities>
{
    ...
    public static void write(com.codepath.apps.restclienttemplate.models.Entities entities$$1, android.os.Parcel parcel$$1, int flags$$0, IdentityCollection identityMap$$0) {
        ...
        if (identity$$0 != -1) {
            ...
            parcel$$1 .writeString(InjectionUtil.getField(java.lang.String.class, com.codepath.apps.restclienttemplate.models.Entities.class, entities$$1, "type"));
            parcel$$1 .writeString(InjectionUtil.getField(java.lang.String.class, com.codepath.apps.restclienttemplate.models.Entities.class, entities$$1, "media_url"));
        }
    }
    ...
    public static com.codepath.apps.restclienttemplate.models.Entities read(android.os.Parcel parcel$$3, IdentityCollection identityMap$$1) {
        ...
        if (identityMap$$1 .containsKey(identity$$1)) {
            ...
            InjectionUtil.setField(com.codepath.apps.restclienttemplate.models.Entities.class, entities$$4, "type", parcel$$3 .readString());
            InjectionUtil.setField(com.codepath.apps.restclienttemplate.models.Entities.class, entities$$4, "media_url", parcel$$3 .readString());
